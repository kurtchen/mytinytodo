...
$().ready(function(){
    ...
    mytinytodo.setCurList({id:"<?php echo isset($_GET['listid']) ? $_GET['listid'] : '1'; ?>"});
});
</script>
...
<input type="hidden" name="id" value="<?php echo isset($_GET['listid']) ? $_GET['listid'] : '1' ?>" />
...
<div class="form-row"><div class="h"><?php _e('task');?></div> <input type="text" name="task" value="<?php echo isset($_GET['title']) ? $_GET['title'] : '' ?>" class="in500" maxlength="250" /></div>
<div class="form-row"><div class="h"><?php _e('note');?></div> <textarea name="note" class="in500"><?php echo isset($_GET['notes']) ? $_GET['notes'] : '' ?></textarea></div>
<div class="form-row"><div class="h"><?php _e('tags');?></div>
 <table cellspacing="0" cellpadding="0" width="100%"><tr>
  <td><input type="text" name="tags" id="edittags" value="<?php echo isset($_GET['tags']) ? $_GET['tags'] : '' ?>" class="in500" maxlength="250" /></td>
